...
{
    /**
     * Create media_folders table (Media Module)
     *
    ...
    public function up(): void
    {
        Schema::create('media_folders', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('parent_id')->nullable()->index(); // Self-reference to media_folders

            $table->timestamps();

            // NO foreign keys - module independence
            // $table->foreign('parent_id')->nullable()->constrained('media_folders')->onDelete('cascade'); // ❌ REMOVED
        });
    }
