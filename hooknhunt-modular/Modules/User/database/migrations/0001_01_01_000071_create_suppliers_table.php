...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('suppliers', function (Blueprint $table) {
            ...
            $table->decimal('wallet_balance', 10, 2)->default(0); // Tracks credit/debit in BDT
            $table->decimal('credit_limit', 10, 2)->default(0); // Maximum negative balance
            $table->text('wallet_notes')->nullable(); // Transaction history (JSON)
