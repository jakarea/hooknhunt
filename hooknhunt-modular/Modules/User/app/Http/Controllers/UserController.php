...
namespace Modules\User\Http\Controllers; // Namespace updated to V2

use App\Http\Controllers\Controller;
use Modules\User\Http\Requests\ApiRequest; // আমাদের তৈরি করা সেই সিকিউর বেস রিকোয়েস্ট
use Modules\User\Models\User;
use Modules\User\Models\CustomerProfile;
