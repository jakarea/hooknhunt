          ...
          <div className="col-span-1">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a
                ...
                className="w-10 h-10 bg-gray-200 dark:bg-[#2a2a2a] rounded-full flex items-center justify-center hover:bg-[#bc1215] transition-colors group"
              >
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/products?category=rods" className="text-[17px] text-gray-600 dark:text-gray-400 hover:text-[#bc1215] transition-colors flex items-center group">
                  <span className="w-1.5 h-1.5 bg-gray-600 dark:bg-gray-700 rounded-full mr-2 group-hover:bg-[#bc1215] transition-colors"></span>
                  {t('nav.rods')}
                </Link>
              </li>
              <li>
