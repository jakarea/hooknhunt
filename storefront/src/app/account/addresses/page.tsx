        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[95vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              {/* Default Address */}
              <div className="flex items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl">
                <input
                  type="checkbox"
                  name="is_default"
                  id="is_default"
                ...
                <label htmlFor="is_default" className="ml-3 block text-sm text-gray-700 cursor-pointer">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">This will be your primary address for orders</p>
                </label>
              </div>
