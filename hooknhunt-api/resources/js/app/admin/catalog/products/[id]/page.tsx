    ...
    <Box p={{ base: 'md', md: 'xl' }}>
      <Stack gap="lg">
        ...
        <Paper withBorder p="md" radius="md">
          <Group justify="space-between" align="flex-start" wrap={{ base: 'wrap', sm: 'nowrap' }}>
            <Stack gap="xs" style={{ flex: 1 }}>
              ...
              {product.shortDescription && (
                <Box
                  className="text-sm md:text-base **:text-inherit **:p:mb-2 **:ul:list-disc **:ul:ml-4 **:ol:list-decimal **:ol:ml-4 **:strong:font-semibold **:em:italic"
                  mt="xs"
              ...
              <Paper withBorder p="md" radius="md">
                <Group gap="md" align="flex-start">
                  ...
                  <Stack gap={0} style={{ flex: 1 }}>
                    ...
                    <Box
                      className="text-base md:text-lg **:text-inherit **:p:mb-2 **:ul:list-disc **:ul:ml-4 **:ol:list-decimal **:ol:ml-4 **:strong:font-semibold **:em:italic"
                      dangerouslySetInnerHTML={{ __html: product.warrantyDetails }}
                    />
                  </Stack>
                </Group>
              </Paper>
        ...
        <Paper withBorder p="md" radius="md">
          ...
          {product.description && (
            <Stack gap="xs" mt="md">
              ...
              <Box
                className="text-sm md:text-base **:text-inherit **:p:mb-2 **:ul:list-disc **:ul:ml-4 **:ol:list-decimal **:ol:ml-4 **:strong:font-semibold **:em:italic **:h1:text-xl **:h1:font-bold **:h2:text-lg **:h2:font-semibold **:h3:text-base **:h3:font-semibold"
