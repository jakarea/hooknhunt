...
class EmployeeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendSuccess($query->paginate(20), 'Employee list fetched');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return $this->sendSuccess($user->load('profile.department'), 'Employee onboarded successfully');
    ...
    {
        $employee = User::with(['profile.department', 'role', 'attendances' => function($q) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return $this->sendSuccess($user->load('profile'), 'Employee updated successfully');
