...
function AuthProvider({ children }) {
    ...
    const checkAuth = async ()=>{
        try {
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isAuthenticated()) {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getMe();
                const user = response.data?.user || response.user;
                if (user) {
                    setUser(user);
...
"[project]/src/lib/i18n.ts [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6b23ed0c._.js.map